...
public class CurrencyConverterCLI {
    ...
    public static void main(String[] args) {
       ...
       /* // инициализируем объекты с помощью конструктора по умолчанию
        CurrencyConverter[] rates = new CurrencyConverter[3];
        CurrencyConverter[] currencies = new CurrencyConverter[3];
